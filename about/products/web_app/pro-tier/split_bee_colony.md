...
- ✅ Shake extra nurse bees into split if needed
...
- **Caution**: Late summer (less time to build up)
...
### 🔗 Related Features
- [🫶🏻 Join Colonies](join_bee_colonies.md) - Opposite operation: merge two hives together
- [📦 Hive Management](../hobbyist-tier/📦%20Hive%20management.md) - Core hive CRUD operations
- [🖼️ Frame Side Management](../hobbyist-tier/🖼️%20Frame%20side%20management.md) - Frame data structure
- [👑 Queen Management](../hobbyist-tier/👑%20Queen%20management.md) - Queen tracking across colonies
