...
| Company Value                                                                          | Color                 | What is color-coded in the app UI | [web_app](../products/web_app/web_app.md) | [beehive_camera](../products/beehive_camera/beehive_camera.md) | [robotic_beehive](../products/robotic_beehive/robotic_beehive.md) |
| -------------------------------------------------------------------------------------- | --------------------- | --------------------------------- | ----------------------------------------------- | ------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
